...
### What to upload to NotebookLLM

- Upload relevant textbooks, research papers, and every lecture transcript you could find on the subject.
...
- In 20 minutes he had a 
    - map of the entire intellectual landscape of the field:
...
- Spent the next 6 hours answering those questions using the source material. Every wrong answer triggered a follow-up
