...
### Fastly MCP server
- A Model Context Protocol (MCP) server that provides AI agents with secure access to Fastly services. 
- Ask your AI assistant to manage CDN configurations, deploy Compute services, analyze performance metrics, and more - all through simple `conversational commands.`
- What it can do? 
